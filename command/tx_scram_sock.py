...
# Title: Tx Scram Sock
# Generated: Sun May 21 01:53:45 2017
##################################################
...
class tx_scram_sock(gr.top_block):
    ...
    def __init__(self, addr='127.0.0.1', alpha=0.5, bb_gain=1, port='4000', samp_rate=500e3, samps_per_symb=4, tx_correct=0, tx_freq=2395e6, tx_gain=20, tx_offset=50e3):
