...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(1090000000, self.samp_rate)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--parameter-0", dest="parameter_0", type="eng_float", default=eng_notation.num_to_str(0),
        help="Set parameter_0 [default=%default]")
    return parser
