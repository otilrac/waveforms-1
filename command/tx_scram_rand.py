...
# Title: Tx Scram Rand
# Generated: Sun May 21 02:42:59 2017
##################################################
...
class tx_scram_rand(gr.top_block):
    ...
    def __init__(self, addr='127.0.0.1', alpha=0.5, bb_gain=1, port='4000', samp_rate=500e3, samps_per_symb=4, tx_correct=0, tx_freq=2395e6, tx_gain=20, tx_offset=0, tx_period=500, update_period=2000):
        ...
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_gr_complex, 1, 1000, "packet_len2")
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_gr_complex, 1, 24000, "packet_len")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100e3, .25, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_stream_to_tagged_stream_0_0, 0))
        ...
        self.connect((self.digital_dxpsk_mod_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
