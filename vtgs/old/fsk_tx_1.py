...
# Generated: Thu Jun 15 10:06:55 2017
##################################################
...
class fsk_tx_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, addr='0.0.0.0', bb_gain=.4, rx_gain=20, tx_correct=0, tx_freq=433e6, tx_gain=20, tx_offset=50e3):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_tx_1")
...
def main(top_block_cls=fsk_tx_1, options=None):
    if options is None:
